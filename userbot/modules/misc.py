...
async def reedme(event):
    await event.edit(
        ...
        "\n[Fizilions README.md file](https://github.com/geopd/ProjectFizilion/blob/dragon/README.md)"
)
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Click here](https://github.com/geopd/ProjectFizilion) to open Fizilion's GitHub Repo."
    )
